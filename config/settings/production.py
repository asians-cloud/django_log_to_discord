...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["asians.cloud"])
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="Django Log To Discord <noreply@asians.cloud>"
)
